...
* Add integration for this repository
    - Go to [travisci.org](travisci.org) and make an account if you don't already have one.
...
* Add a badge to your README
    - back on [travisci.org](travisci.org) click on your project, you should see your tests passing (or failing)
